 ...
 *
 * JNI class: com.vitorpamplona.schnorr256k1.Schnorr256k1
 */
#include <jni.h>
...
#define JNI_CLASS "com/vitorpamplona/schnorr256k1/Schnorr256k1"
...
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativeInit(JNIEnv *env, jclass cls) {
    (void)env; (void)cls;
    secp256k1c_init();
}
...
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativePubkeyCreate(
...
JNIEXPORT jbyteArray JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativePubkeyCompress(
...
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativeSecKeyVerify(
    JNIEnv *env, jclass cls, jbyteArray seckey
) {
    (void)cls;
    uint8_t sk[32];
...
JNIEXPORT jbyteArray JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativeSchnorrSign(
...
JNIEXPORT jbyteArray JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativeSchnorrSignXOnly(
...
JNIEXPORT jboolean JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativeSchnorrVerify(
...
JNIEXPORT jboolean JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativeSchnorrVerifyFast(
    JNIEnv *env, jclass cls, jbyteArray sig, jbyteArray msg, jbyteArray pub
) {
    (void)cls;
    uint8_t s[64], p[32];
...
JNIEXPORT jboolean JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativeSchnorrVerifyBatch(
...
JNIEXPORT jbyteArray JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativePrivKeyTweakAdd(
...
JNIEXPORT jbyteArray JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativePubKeyTweakMul(
...
JNIEXPORT jbyteArray JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativeEcdhXOnly(
...
JNIEXPORT jbyteArray JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativeSha256(
...
JNIEXPORT jbyteArray JNICALL
Java_com_vitorpamplona_schnorr256k1_Schnorr256k1_nativeTaggedHash(
    JNIEnv *env, jclass cls, jstring tag, jbyteArray msg
) {
    (void)cls;
    const char *tag_str = (*env)->GetStringUTFChars(env, tag, NULL);
    if (!tag_str) return NULL;
    ...
    uint8_t out[32];
    secp256k1c_tagged_hash(out, tag_str, msg_buf, msg_len);
